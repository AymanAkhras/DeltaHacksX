...
class FaceReader:
    ...
    def data_collection(self):
        ...
        while True:
            ...
            rects = detector2.detectMultiScale(img_gray, scaleFactor=1.1,
            ...
            for (x, y, w, h) in rects:
                ...
                if ear < self.blink_thresh:
                    ...
                    COUNTER += 1
                    if time_since_last_blink - self.last_blink_update_time >= 3:
                        cv2.putText(frame, "Blink Alert", (10, 100),
                ...
                cv2.putText(frame, "EAR: {:.2f}".format(ear), (300, 25),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                cv2.putText(frame, "YAWN: {:.2f}".format(distance), (300, 50
                                                                        ),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
